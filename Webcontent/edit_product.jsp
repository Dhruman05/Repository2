            ...
            <div class="row">
               <div class="col-lg-8 offset-lg-2">
                  ...
                  <p>
            		  	...
            		  	{
            		  		p=(Product)session.getAttribute("p");
            		  	}
                     ...
                     <form action="ProductController" method="post"  >
                        <fieldset>
                        	<input type="hidden" name="product_seller" value="<%=p.getPid()%>">
                           <input type="hidden" name="pid" value="<%=u.getId()%>">
                           <input type="text" name="gender" value="<%=p.getGender()%>" readonly="readonly">
                           <input type="text" name="product_category" value="<%=p.getProduct_category()%>">
